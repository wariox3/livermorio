...
export const DASHBOARD_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'reclamos',
        loadChildren: () =>
          import('../reclamos/reclamos.routes').then(m => m.RECLAMOS_ROUTES),
      },
      {
        path: 'solicitudes',
        loadChildren: () =>
      ...
      },
      {
        ...
        loadChildren: () =>
          import(
            '../certificado-laboral-historico/certificado-laboral-historico.routes'
          ).then(m => m.CERTIFICADO_LABORAL_HISTORICO_ROUTES),
      },
      {
      ...
      },
      {
        path: 'turnos',
        loadChildren: () =>
          import('../turnos/turnos.routes').then(m => m.TURNOS_ROUTES),
      },
